            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-10 mx-auto">
                    <form class="custom-form ticket-form mb-5 mb-lg-0" action="#" method="post" role="form">
                        ...
                        <p class="text-black">Ainsi pour le SH’23 le thème est <b>« Le protocole de la royauté »</b> . Cela dit pour participer au SH'22 chaque participant devra de prémunir de :</p>
                        <ul class="text-black">
